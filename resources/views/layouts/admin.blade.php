...
<html>
  <head>
    ...
    <title>SisHotel | www.AguaymantoHotel.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>SistemaHotel</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      cargo - Desarrollando Software
                      <small>no se que poner aca</small>
                    </p>
                  </li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Gestion de Hoteles</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="#">AguaymantoHotel</a>.</strong> All rights reserved.
      </footer>
